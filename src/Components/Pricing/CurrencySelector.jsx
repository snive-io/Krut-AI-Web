...
function CurrencySelector({ currency, setCurrency }) {
    return (
        <div className="px-8 sm:px-4 xl:px-8 2xl:px-16 my-2 md:my-4 lg:mb-10">
            ...
            {currency !== "USD" && <div className="rounded-3xl border border-krutNeon border-opacity-40 text-white mt-10 p-5 border-l-8 flex items-center">
                <span className="material-symbols-outlined pe-3 text-krutNeon">  notification_important </span>
                <p> *Actual price may vary based on the exchange rate in place between USD and {currency} at the time of payment processing or invoicing. Prices exclude all taxes, levies and duties.</p>
            </div>}
