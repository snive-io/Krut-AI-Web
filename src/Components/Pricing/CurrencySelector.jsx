    ...
    return (
        <div className="px-8 sm:px-4 xl:px-8 2xl:px-16 my-2 md:my-4 lg:mb-10">
            <div className="rounded-3xl border border-krutNeon border-opacity-40 text-white p-5 border-l-8 flex items-center">
                ...
                <p>{currency !== "USD" && <span>Actual price may vary based on the exchange rate in place between USD and {currency} at the time of payment processing or invoicing. </span>}Prices exclude all taxes, levies and duties.</p>
            </div>
